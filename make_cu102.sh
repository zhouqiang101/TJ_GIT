...
echo "************************************************"
echo "This script will build image for EC200T lte module"
echo "************************************************"
sleep 3
cd $TOPDIR
rm filesystem/files/etc/ppp/peers/lte >/dev/null 2>&1
cp ppp_script/lte-l210 filesystem/files/etc/ppp/peers/lte >/dev/null 2>&1
cp ppp_script/lte-connect-l210 filesystem/files/etc/ppp/peers/lte-connect >/dev/null 2>&1
