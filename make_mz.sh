...
cp ppp_script/lte-mz filesystem/files/etc/ppp/peers/lte >/dev/null 2>&1
cp ppp_script/lte-connect-mz filesystem/files/etc/ppp/peers/lte-connect >/dev/null 2>&1
