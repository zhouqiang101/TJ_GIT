...
deps_net/wireguard/crypto/blake2s.o := \
  ...
  net/wireguard/crypto/../selftest/blake2s.h \

net/wireguard/crypto/blake2s.o: $(deps_net/wireguard/crypto/blake2s.o)
